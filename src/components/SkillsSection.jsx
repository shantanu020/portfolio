...
const SkillsSection = () => {
    ...
    const fileteredSkills = skills.filter((skill)=>activeCategory==="all"||skill.category===activeCategory)
                ...
                {fileteredSkills.map((skill, key)=>(
                    ...
                    className='p-6 bg-card rounded-lg shadow-xs card-hover'>
                        ...
                        <div className='w-full bg-secondary/50 h-2 rounded-full overflow-hidden'>
                            <div className={cn('bg-primary h-2 rounded-full origin-left animate-[grow_1.5s_ease-out]')} style={
                                {width: `${skill.level}%`}}
                            />
                        </div>
